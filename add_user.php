	...
	if(isset($_POST["gender_input"])){
	  ...
	  if(!empty($_POST["password_input"])){
		  if(strlen($_POST["password_input"])<8){
			  $password_error = "Liiga lühike salasona!";
		  }
	  } else {
	  ...
	  if(empty ($name_error) and empty ($birth_month_error) and empty ($surname_error) and empty ($birth_year_error) and empty ($birth_day_error) and empty ($birth_date_error) and empty ($gender_error) and empty ($email_error) and empty ($password_error) and empty ($confirm_password_error)){
